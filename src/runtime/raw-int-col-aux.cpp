...
void raw_int_col_aux_update_unchecked(UNARY_TABLE *master, INT_COL_AUX *col_aux, uint32 index, int64 value) {
...
void raw_int_col_aux_update_existing_unchecked(UNARY_TABLE *master, INT_COL_AUX *col_aux, uint32 index, int64 value) {
  //## THERE OUGHT TO BE SOME EXTRA CHECKS HERE IN DEBUG MODE
