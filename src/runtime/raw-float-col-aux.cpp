...
void raw_float_col_aux_update_unchecked(UNARY_TABLE *master, FLOAT_COL_AUX *col_aux, uint32 index, double value) {
...
void raw_float_col_aux_update_existing_unchecked(UNARY_TABLE *master, FLOAT_COL_AUX *col_aux, uint32 index, double value) {
  //## THERE OUGHT TO BE SOME EXTRA CHECKS HERE IN DEBUG MODE
