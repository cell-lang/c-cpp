...
void int_col_aux_record_key_violation_1(OBJ_COL *table, OBJ_COL_AUX *table_aux, char *err_msg, const char *table_name) {
    snprintf(err_msg, 256, "The key on the first column of %s was violated", table_name);
}

void float_col_aux_record_key_violation_1(OBJ_COL *table, OBJ_COL_AUX *table_aux, char *err_msg, const char *table_name) {
    snprintf(err_msg, 256, "The key on the first column of %s was violated", table_name);
}
